...
Apply7.grid(row=3, column=0, columnspan=8, sticky = W+E+N+S)

Apply8 = Button(Maps, bg="white",text="Scatter Map (populations: press 'Cumulative' before)")
Apply8.grid(row=4, column=0, columnspan=8, sticky = W+E+N+S)
